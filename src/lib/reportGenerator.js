...
export function generateReport(data) {
  ...
  let athlete_level;
  if (score >= 14) athlete_level = 'Advanced';
  else if (score >= 7) athlete_level = 'Intermediate';
  else athlete_level = 'Beginner';
  ...
  const athlete_summary = `${data.full_name} is at the ${athlete_level} level with ${exp} of calisthenics training experience. ` +
