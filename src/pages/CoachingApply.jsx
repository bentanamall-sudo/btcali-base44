...
import { Zap, CheckCircle, Crown, Target, ChevronDown, Trophy, Flame } from 'lucide-react';
...
export default function CoachingApply() {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 max-w-3xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.10 }}
        ...
        <Link to="/scan">
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full flex items-center justify-center gap-2 py-4 rounded-xl gradient-bg-strong text-primary-foreground font-heading font-bold text-base"
      ...
      {/* 3 — BTCALI Coaching Details dropdown */}
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.13 }} className="mb-6">
        <button
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-heading font-semibold text-foreground text-sm sm:text-base">BTCALI Coaching Details</span>
          </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
        <button
          ...
          className="w-full flex items-center justify-between gap-3 glass rounded-xl px-5 py-4 border border-border/30 hover:border-primary/30 transition-all mb-0"
        >
          <div className="flex items-center gap-3">
            <Zap className="w-4 h-4 text-primary flex-shrink-0" />
            <span className="font-heading font-bold text-foreground text-sm sm:text-base">What Is Included</span>
          </div>
