  ...
  return (
    <>
      <motion.div
        ...
        className={`rounded-2xl border overflow-hidden relative ${comingSoon ? 'border-border/20 bg-card/30 opacity-60' : 'border-border/25 bg-card/60 card-premium hover:border-primary/35'}`}
      >
