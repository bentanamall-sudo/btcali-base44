...
const CATEGORY_DATA = {
  ...
  'handstand-foundations': {
    ...
    tutorials: [
      ...
      { id: 'hf-bail', title: 'Handstand Bail — Face the Fear', level: 'Beginner', sub: 'Beginner', videoId: '8GLA_c0jueA', free: true },
  ...
  'l-sit-to-handstand': {
    ...
    tutorials: [
      ...
      { id: 'lshs-bail', title: 'Handstand Bail — Face the Fear', level: 'Beginner', sub: 'Foundation', videoId: '8GLA_c0jueA', free: false },
